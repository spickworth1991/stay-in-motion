...
export default function Resources() {
  ...
  const desc =
    "A curated collection of practical physical therapy PDF resources—stretching, rehab, telehealth prep, flexibility, work guides, and more.";
  ...
  const docs = [
    {
      ...
      blurb: "A mindful approach to stretching that enhances flexibility, awareness, and neuromuscular coordination.",
    },
    {
      ...
      blurb: "Illustrated flexibility techniques from the Osher Center at University of Wisconsin.",
    },
    {
      title: "Low Back Pain Exercise Sheet",
      href: "https://uhs.berkeley.edu/sites/default/files/lowbackpain.pdf",
      blurb: "Simple stretching routines targeting the lower back—visual and easy to follow.",
    },
    {
      ...
      blurb: "Detailed guidance for returning safely to work with injury‑adapted tasks.",
    },
    {
      ...
      blurb: "Evidence-based guide to building strength in aging populations—exercise plans included.",
    },
    {
      ...
      blurb: "Explains outpatient rehab services, billing, documentation, and Medicare procedures.",
    },
    {
      ...
      blurb: "HHS guide to help patients prepare and feel confident for telehealth PT sessions.",
    },
    {
      title: "Walk With Ease – Coaching Manual",
      href: "https://geriatrictoolkit.missouri.edu/consumer/Walk_With_Ease_AF_Manual.pdf",
      blurb: "Evidence‑based walking program manual to increase safe activity.",
    },
  ];
