  ...
  return (
    <>
      <SEO
        ...
        description="Personalized physical therapy, dry needling, recovery sessions, and sports rehab in Livonia, MI. Get moving, keep moving, stay in motion."
        canonical="https://stayinmotionpt.com/"
        ogImage="https://stayinmotionpt.com/PT-Logo.png"
        jsonLd={jsonLd}
      />

      {/* Extra helpful metas (theme + geo + preload) */}
      ...
      >
        <div className="relative z-10 text-center space-y-6 max-w-2xl w-full">
          ...
          <motion.div
            className="mx-auto w-full max-w-lg sm:max-w-2xl md:max-w-3xl lg:max-w-4xl rounded-2xl overflow-hidden shadow-2xl aspect-video"
      ...
      <section className="bg-white dark:bg-gray-800 px-4 py-12 border-t border-gray-200 dark:border-gray-700">
        <div className="max-w-4xl mx-auto space-y-6 text-center">
          ...
          <p className="text-gray-700 dark:text-gray-200 text-lg">
            ...
            <strong> chronic pain</strong> and <strong>balance issues</strong>.
          </p>
