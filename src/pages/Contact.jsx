...
export default function Contact() {
  ...
  const handleSubmit = (e) => { e.preventDefault(); console.log("Submitting", form); };
  ...
  const title = "Contact | Stay in Motion Physical Therapy";
  const desc = "Have questions or ready to schedule? Contact Stay in Motion Physical Therapy.";
  const canonical = "https://stayinmotionpt.com/contact";
  const ogImage = "https://stayinmotionpt.com/og/contact.jpg";
  const jsonLd = {
  ...
  return (
    <>
      ...
      <section className="py-16 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        >
          {[
            { icon: FaPhoneAlt, label: "Phone", value: "(555) 123-4567" },
            { icon: FaEnvelope, label: "Email", value: "hello@stayinmotionpt.com" },
            { icon: FaMapMarkerAlt, label: "Address", value: "123 Main St, Hometown, USA" },
          ].map((info, i) => (
            <motion.div
              key={info.label}
        ...
        >
          {[
            ...
            <motion.div key={field.name} className="mb-6" custom={i} variants={fieldVariants}>
          ...
          <motion.div className="mb-6" custom={3} variants={fieldVariants}>
            ...
            <textarea
              ...
              required
              className="w-full bg-white dark:bg-gray-900 border border-gray-300 rounded-lg px-4 py-3
                         focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition resize-none"
            />
          </motion.div>
